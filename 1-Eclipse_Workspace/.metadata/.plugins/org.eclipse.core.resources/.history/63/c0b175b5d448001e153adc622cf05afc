...
void DIO_VidInit (void)
{
	...
	DDRB_U8_REG = Reg_Problem(DIO_PINB0_INITIAL_DIR,
	...
	DDRC_U8_REG = Reg_Problem(DIO_PINC0_INITIAL_DIR,
	...
	DDRD_U8_REG = Reg_Problem(DIO_PIND0_INITIAL_DIR,
	...
	/* Initiate PORTx */
	PORTA_U8_REG = Reg_Problem(DIO_PINA0_INITIAL_VAL,
	...
	PORTB_U8_REG = Reg_Problem(DIO_PINB0_INITIAL_VAL,
	...
	PORTC_U8_REG = Reg_Problem(DIO_PINC0_INITIAL_VAL,
	...
	PORTD_U8_REG = Reg_Problem(DIO_PIND0_INITIAL_VAL,
