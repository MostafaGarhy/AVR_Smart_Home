...
const u8 LCD_Data_Pins[4] = {LCD_DATA_PIN4, LCD_DATA_PIN5, LCD_DATA_PIN6, LCD_DATA_PIN7};

void CLCD_VidSendCmd(u8 Copy_U8Cmd)
{
#if 	(LCD_MODE ==	LCD_8_BIT_MODE)
		/* Control pins settings */
		DIO_VidSetPinValue(LCD_CTRL, LCD_RS_PIN, DIO_PIN_LOW);
		DIO_VidSetPinValue(LCD_CTRL, LCD_RW_PIN, DIO_PIN_HIGH);

		/* Entering the command here */
		DIO_VidSetPortValue(LCD_PORT, Copy_U8Cmd);

		/* Enable sequence */
		DIO_VidSetPinValue(LCD_CTRL, LCD_EN_PIN, DIO_PIN_HIGH);
		delay_ms(2);
		DIO_VidSetPinValue(LCD_CTRL, LCD_EN_PIN, DIO_PIN_LOW);
#elif 	(LCD_MODE == LCD_4_BIT_MODE)
		/* Control pins settings */
		DIO_VidSetPinValue(LCD_CTRL, LCD_RS_PIN, DIO_PIN_LOW);
		DIO_VidSetPinValue(LCD_CTRL, LCD_RW_PIN, DIO_PIN_LOW);
...
void CLCD_VidInit(void)
{
		...
		DIO_VidSetPortDirection(LCD_PORT, DIO_PORT_ALL_OUTPUT);
		DIO_VidSetPinDirection(LCD_CTRL, LCD_RS_PIN, DIO_PIN_OUTPUT);
		DIO_VidSetPinDirection(LCD_CTRL, LCD_RW_PIN, DIO_PIN_OUTPUT);
		DIO_VidSetPinDirection(LCD_CTRL, LCD_EN_PIN, DIO_PIN_OUTPUT);
...
#if 	(LCD_MODE   ==	LCD_8_BIT_MODE)
		/* Control pins settings */
		DIO_VidSetPinValue(LCD_CTRL, LCD_RS_PIN, DIO_PIN_HIGH);
		DIO_VidSetPinValue(LCD_CTRL, LCD_RW_PIN, DIO_PIN_LOW);
